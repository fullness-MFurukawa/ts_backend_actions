...
describe('値オブジェクト:ProductPriceの単体テスト', () => {
    ...
    describe('equals()メソッド', () => {
        it('同じ値を持つProductPriceインスタンスが等しいと判断される', () => {
            ...
            const price2 = ProductPrice.fromNumber(100);
